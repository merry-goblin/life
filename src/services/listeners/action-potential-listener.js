...
(function(life) {
	...
	life.ActionPotentialListener = function() {
		...
		var scope = {
			...
			add: function(actionPotentialKey) {

				this.trigger('add', actionPotentialKey);
			},

			remove: function(actionPotentialKey) {

				this.trigger('remove', actionPotentialKey);
			},
